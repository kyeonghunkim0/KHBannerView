#
#  Be sure to run `pod spec lint KHBannerView.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "KyeongHun Kim"
  # spec.authors            = { "KyeongHun Kim" => "kimkhuna1@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/KyeongHun Kim"
